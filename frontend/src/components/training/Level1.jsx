...
const Level1 = ({ onBack }) => {
  ...
  const startNewQuestion = () => {
    ...
    const options = generateHoleCardsOptions(community);
  ...
  const handleSelect = (index) => {
    ...
    setFeedback({
      isCorrect,
      message: isCorrect
        ? 'Correct! You found the nuts!'
        : 'Not quite. The nuts were highlighted.',
    ...
    return (
      <div>
        ...
        <div className="max-w-2xl mx-auto bg-gray-800 rounded-xl p-8 text-center">
          <h2 className="text-4xl font-bold text-poker-blue-400 mb-4">Round Complete!</h2>
    ...
    return (
      <div>
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-poker-blue-400 mb-4">
            Level 1: Find the Nuts
          </h1>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 max-w-5xl mx-auto mb-8">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-sm text-gray-400">60 seconds to get as many correct as possible</p>
            </div>
          </button>
